...
export const initialLaneExceptions: LaneException[] = [
  ...
  },
  {
    ...
    confidence: 'High',
    impact: 'Low',
    accountManager: 'Kevin Plummer',
    customer: 'Costco Wholesale',
    carrier: 'Pacific Freight Logistics',
    isKeyAccount: true
  },
  {
    id: 'exc-oak-under-2',
  ...
  },
  {
    ...
    customer: 'Ross Stores, Inc.',
    carrier: 'Columbia River Hauling',
    isKeyAccount: true
  },
  {
    id: 'exc-den-1',
  ...
  },
  {
    ...
    confidence: 'High',
    impact: 'High',
    accountManager: 'Brian Murphy',
    customer: 'Procter & Gamble',
    carrier: 'Brosky\'s Trucking Inc',
    isKeyAccount: false
  },
  {
    id: 'exc-la-5',
    ...
    impact: 'High',
    accountManager: 'Drayage Ops',
    customer: 'Discount Tire',
    carrier: 'Amaral Transport LLC',
    isKeyAccount: true
  },
  {
    id: 'exc-la-6',
    ...
    accountManager: 'Alex Vance',
    customer: 'Home Depot Ops',
    carrier: 'Sandino Freight Services',
    isKeyAccount: true
  },
  {
    id: 'exc-la-under-1',
    ...
    confidence: 'High',
    impact: 'Low',
    accountManager: 'Lisa Chang',
    customer: 'FedEx Ground',
    carrier: 'Trokiando Transportation',
    isKeyAccount: true
  },
  {
    id: 'exc-chi-under-1',
  ...
  },
  {
    ...
    impact: 'High',
    accountManager: 'Lisa Chang',
    customer: 'Tyson Foods',
    carrier: 'CRST International',
    isKeyAccount: false
  }
];
...
export const initialPlannedAdjustments: PlannedAdjustment[] = [
  {
    ...
    targetMarketOrLane: 'Oakland Market',
    changePercent: 2.5,
    status: 'Pending Approval',
    effectiveDate: '2026-07-06',
    submittedBy: 'Pricing Team (Sarah Jenkins)',
    submittedDate: '6/22/2026',
    notes: 'Seasonal import peak adjustment for Northern California drayage corridors awaiting GM signoff.'
  },
  {
    id: 'adj-2',
    title: 'LA/LB → Las Vegas Target Adjustment -1.5%',
    targetMarketOrLane: 'LA/LB Corridor',
    changePercent: -1.5,
    status: 'Active',
    effectiveDate: '2026-06-21',
    submittedBy: 'Pricing Analyst (Marcus Vance)',
    submittedDate: '6/18/2026',
    approvedBy: 'General Manager (David Vance)',
    approvedDate: '6/20/2026',
    notes: 'Contract benchmark alignment for Amazon LAS1 volume approved and in effect.'
  },
  {
    id: 'adj-3',
    title: 'Seattle Port Local Drayage +1.8%',
    targetMarketOrLane: 'Seattle Port',
    changePercent: 1.8,
    status: 'Scheduled',
    effectiveDate: '2026-07-13',
    submittedBy: 'Pricing Team (Kevin Plummer)',
    submittedDate: '6/21/2026',
    approvedBy: 'VP of Pricing & Ops',
    approvedDate: '6/22/2026',
    notes: 'NW region fuel and terminal congestion surcharge re-index scheduled for July 13.'
  }
];
