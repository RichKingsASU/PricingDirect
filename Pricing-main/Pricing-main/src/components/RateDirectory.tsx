...
export const RateDirectory: React.FC<RateDirectoryProps> = ({
  ...
  const [statusFilter, setStatusFilter] = useState<'All' | 'Active' | 'Future' | 'Expired'>('All');
  ...
  const filteredLanes = lanes.filter((lane) => {
    ...
    const matchesStatus = statusFilter === 'All' || lane.activeState === statusFilter;
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            <div className="flex flex-col">
              ...
              <div className="flex gap-1">
                {(['All', 'Active', 'Future', 'Expired'] as const).map((st) => (
                  <button
                    key={st}
              ...
              {filteredLanes.map((lane) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="mt-2.5 pt-2 border-t border-[#E2E8F0]/70 flex items-center justify-between gap-2 text-[11px]">
                      <div className="flex items-center gap-1.5 text-[#1769FF] font-extrabold">
                        <span className="material-symbols-outlined text-[14px]">analytics</span>
                        <span>Carrier Target: ${lane.carrierTargetMatch.targetAmount.toLocaleString()}</span>
                        <span className="text-[9px] bg-[#EAF2FF] text-[#1769FF] border border-[#1769FF]/20 px-1.5 py-0.2 rounded font-black uppercase">
                          {lane.carrierTargetMatch.matchPercent}% Target
                        </span>
                      </div>
                      <div className="flex items-center gap-1 text-[#64748B] text-[10px] font-semibold">
                        <span className="material-symbols-outlined text-[13px]">forklift</span>
